...
public class SearchTestIncorrectAttributeSelected extends AbstractSearchAndReplaceTestCase {
  ...
  protected void setMetaClasses(CapellaSearchSettings searchSettings) {
    SearchForClassItem item = new SearchForClassItem(CtxPackage.Literals.SYSTEM_FUNCTION);
